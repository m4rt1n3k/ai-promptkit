...
- Repo: **AI vibecoding** — ProGrammar team workspace for agent handoff workflow and vibecoding practices (migrated from `C:\Users\VLAD\agent-handoff`)
...
**Definition of done (this repo):** Handoff kit present; bootstrap rule active; automation prefill documented; use this folder as the canonical home for the PROMPT/TODO pattern (reference kit + team docs).
...
- [binding] Move context from **agent-handoff** workspace into **AI vibecoding** (this folder).
...
| D5 | Canonical kit in **AI vibecoding** workspace | Team SharePoint/docs location; replaces standalone `agent-handoff` as primary home | Keep only `C:\Users\VLAD\agent-handoff` |

## 5. Current state

- Branch: git not initialized (optional)
- Workspace: `C:\Users\VLAD\České vysoké učení technické v Praze\Team-ProGrammar - Dokumenty\AI vibecoding`
...
- Works: Full kit migrated from `agent-handoff`; bootstrap rule applies in this workspace
- Pending: User saves automation in Cursor UI if not done yet; roll out to other repos (TODO plan-5, plan-6)
- Open questions: Which target repos adopt first (asset-ontology, em-testbench, PV placement)?
...
- Prior kit location: `C:\Users\VLAD\agent-handoff` (superseded by this workspace for team use)
